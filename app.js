...
const questions = [
  {
    ...
    options: ["Sora", "Roxas", "Goofy", "Riku"],
    correctAnswer: "Sora"
  },
  {
    question: "What weapon does Sora use?",
    options: ["Bow", "Sword", "Shield", "Keyblade"],
    correctAnswer: "Keyblade"
  },
  {
    question: "Which two Disney characters travel with Sora?",
    options: ["Mickey and Minnie Mouse", "Donald Duck and Goofy", "Aladdin and Genie", "Buzz Lightyear and Woody"],
    correctAnswer: "Donald Duck and Goofy"
  },
  {
    question: "Which Disney character is the king in Kingdom Hearts?",
    options: [
      "Simba",
      "Jack Sparrow",
      "Mickey Mouse",
  ...
  },
  {
    ...
    options: ["Destiny Islands", "Hollow Bastion", "Twilight Town", "Toronto"],
    correctAnswer: "Destiny Islands"
  }
];
